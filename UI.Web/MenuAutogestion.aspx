...
AutoEventWireup="true" CodeBehind="MenuAutogestion.aspx.cs"
Inherits="UI.Web.MenuAutogestion" %>
<asp:Content
  ID="Content1"
  ...
  <div class="menu-aut-container">
    ...
    <div class="menu-aut-content">
      <ul class="menu-aut">
        ...
        <li>
          <a class="button button01" href="InscripcionesUser.aspx"
            >Inscripciones</a
          >
        </li>
        <li>
