...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" Height="338px" style="margin-top: 9px">
        <asp:Panel ID="Panel2" runat="server" Height="67px">
            <asp:GridView ID="dgvCursos" runat="server" DataKeyNames="ID" OnSelectedIndexChanged="dgvExamenes_SelectedIndexChanged" CssClass="mGrid"
                PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" AutoGenerateColumns="false">
                <Columns>
                    <asp:BoundField HeaderText="IdCurso" DataField="ID" />
            ...
            <asp:Panel ID="Panel3" runat="server" Width="560">
                ID Curso:
                <asp:TextBox ID="txtIdCurso" runat="server" Enabled="False"></asp:TextBox>
                <br />
                ID Materia:
